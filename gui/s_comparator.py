from PySide6.QtWidgets import QWidget, QFrame, QVBoxLayout, QHBoxLayout, QGridLayout, QLineEdit, QLabel, QCheckBox
...
class SComparator(QWidget):
    ...
    def _setup_ui(self, num):
        ...
        lv_layout.setContentsMargins(1,1,1,1)
        ...
        self._addr_box.setMaximumSize(72, 32)
    ...
    def _create_reg(self, width, cmp_switches, ign_switches):
        ...
        bit_frame.setFrameStyle(QFrame.Panel | QFrame.Raised)
