from qtpy.QtWidgets import QWidget, QFrame, QHBoxLayout, QVBoxLayout, QGridLayout, \
...
class WriteW(QWidget):
    ...
    def _setup_ui(self):
        ...
        s1_s2_layout.setContentsMargins(1,1,1,1)
        ...
        write_w_layout.setContentsMargins(1,1,1,1)
        ...
        switch_frame.setFrameStyle(QFrame.Panel | QFrame.Raised)
